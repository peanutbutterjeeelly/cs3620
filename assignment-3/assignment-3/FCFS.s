...
LBB5_19:
	...
	leaq	-736(%rbp), %r9
	leaq	-744(%rbp), %r10
	leaq	__Z16compare_function8job_infoS_(%rip), %r11
	leaq	-888(%rbp), %rbx
	leaq	_jobs(%rip), %r14
	leaq	-960(%rbp), %r15
	movq	%r14, -992(%rbp)
...
LBB5_35:
	leaq	L_.str.9(%rip), %rdi
	cvtsi2sdl	-1324(%rbp), %xmm0
	cvtsi2sdl	-1292(%rbp), %xmm1
	divsd	%xmm1, %xmm0
	movb	$1, %al
	callq	_printf
	leaq	L_.str.9(%rip), %rdi
	cvtsi2sdl	-1328(%rbp), %xmm0
	cvtsi2sdl	-1292(%rbp), %xmm1
	divsd	%xmm1, %xmm0
...
LBB38_17:
	...
	.section	__TEXT,__StaticInit,regular,pure_instructions
	.align	4, 0x90
__GLOBAL__sub_I_FCFS.cpp:               ## @_GLOBAL__sub_I_FCFS.cpp
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp163:
